...
if( $_POST['did_delete'] == 1 ):
	...
	if( $delete_array != '' ):
		//go through the list of IDs, delecting comments one at a time
...
?>
	...
	<form action="" method="post">
		...
		<ul>
			...
			<li>
				<input type="checkbox" name="delete[<?php echo $row_comm['comment_id']; ?>]" value="<?php echo $row_comm['comment_id']; ?>" id="delete-<?php echo $row_comm['comment_id']; ?>" /><!--[] valid in name field only, use "-" for id field-->
