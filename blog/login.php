...
if( $_POST['did_login'] == 1 ){
	...
	$clean_username = clean_input($_POST['username'], $db); //set variable to easier refer to this code, trim trims white space off of user name, strip_tags strips html/php tags entered by the user
	$clean_password = clean_input($_POST['password'], $db); // $password = strip_tags(trim($_POST['password']));
